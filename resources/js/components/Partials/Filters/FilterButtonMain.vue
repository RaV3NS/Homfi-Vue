        ...
        <div style="width: 100%" v-else>
            ...
            <modal :name="store_p + '-modal'" height="auto" :adaptive="true">
                ...
                <div class="filter-toolbar">
                    <a href="#" class="link link-info" v-on:click.stop.prevent="handleRefresh">Сбросить</a>
                    <a href="#" class="btn btn-primary" v-on:click.stop.prevent="$modal.hide(store_p + '-modal');">Продолжить</a>
                </div>
            </modal>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        props: ["text", "store_p", "store_a", "mobile"],
        mounted() {
